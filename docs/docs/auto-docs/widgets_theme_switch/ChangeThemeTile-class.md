...
[[ChangeThemeTile.new](../widgets_theme_switch/ChangeThemeTile/ChangeThemeTile.md)][]
...
[[build](../widgets_theme_switch/ChangeThemeTile/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
