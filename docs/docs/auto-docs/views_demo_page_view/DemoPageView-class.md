...
[[DemoPageView.new](../views_demo_page_view/DemoPageView/DemoPageView.md)][]
...
[[build](../views_demo_page_view/DemoPageView/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
