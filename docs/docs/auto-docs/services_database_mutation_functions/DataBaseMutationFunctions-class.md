...
[DataBaseMutationFunctions.new](../services_database_mutation_functions/DataBaseMutationFunctions/DataBaseMutationFunctions.md)
...
[[clientAuth](../services_database_mutation_functions/DataBaseMutationFunctions/clientAuth.md)] [↔ [GraphQLClient](https://pub.dev/documentation/graphql/5.2.3/graphql/GraphQLClient-class.html)]
:   Client Auth for handling authenticated request.
    ::: features
    getter/setter pair
    :::

[[clientNonAuth](../services_database_mutation_functions/DataBaseMutationFunctions/clientNonAuth.md)] [↔ [GraphQLClient](https://pub.dev/documentation/graphql/5.2.3/graphql/GraphQLClient-class.html)]
...
[[noData](../services_database_mutation_functions/DataBaseMutationFunctions/noData.md)] [↔ [QueryResult](https://pub.dev/documentation/graphql/5.2.3/graphql/QueryResult-class.html)[\<[[Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)?]\>]]
...
[clearGraphQLCache](../services_database_mutation_functions/DataBaseMutationFunctions/clearGraphQLCache.md) [→ void ]
...
[[gqlAuthSubscription](../services_database_mutation_functions/DataBaseMutationFunctions/gqlAuthSubscription.md)][([[[String](https://api.flutter.dev/flutter/dart-core/String-class.md)] subscription, ) [→ [Stream](https://api.flutter.dev/flutter/dart-core/Stream-class.html)[\<[[QueryResult](https://pub.dev/documentation/graphql/5.2.3/graphql/QueryResult-class.html)[\<[[Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)?]\>]]\>]] ]
:   This function is used to run the graph-ql subscription for
    authenticated user.
