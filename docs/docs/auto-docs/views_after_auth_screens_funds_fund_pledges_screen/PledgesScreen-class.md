...
1.  [talawa](../index.md)
2.  [views/after_auth_screens/funds/fund_pledges_screen.dart](../views_after_auth_screens_funds_fund_pledges_screen/)
3.  PledgesScreen class
...
[[PledgesScreen.new](../views_after_auth_screens_funds_fund_pledges_screen/PledgesScreen/PledgesScreen.md)][]
...
[[campaign](../views_after_auth_screens_funds_fund_pledges_screen/PledgesScreen/campaign.md)] [→ [Campaign](../models_funds_fund_campaign/Campaign-class.md)]
...
[createState](../views_after_auth_screens_funds_fund_pledges_screen/PledgesScreen/createState.md) [→ \_PledgesScreenState ]
...
1.  [talawa](../index.md)
2.  [fund_pledges_screen](../views_after_auth_screens_funds_fund_pledges_screen/)
3.  PledgesScreen class

##### fund_pledges_screen library
