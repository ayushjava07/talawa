...
[[ManageMembersDialog.new](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/ManageMembersDialog.md)][]
...
[[chat](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/chat.md)] [→ [Chat](../models_chats_chat/Chat-class.md)?]
:   The current chat object.
    ::: features
    final
    :::

[[chatId](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/chatId.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[model](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/model.md)] [→ [GroupChatViewModel](../view_model_after_auth_view_models_chat_view_models_group_chat_view_model/GroupChatViewModel-class.md)]
:   The GroupChatViewModel instance.
    ::: features
    final
    :::

[[onMemberRemoved](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/onMemberRemoved.md)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
...
[[userConfig](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/userConfig.md)] [→ [UserConfig](../services_user_config/UserConfig-class.md)]
...
[[createState](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[ManageMembersDialog](../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog-class.md)]\>]] ]
