...
ChatInputField returns a widget that has mutable state
...
[[ChatInputField.new](../views_after_auth_screens_chat_widgets_chat_input_field/ChatInputField/ChatInputField.md)][]
