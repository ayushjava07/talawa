...
1.  [talawa](../index.md)
2.  [views/after_auth_screens/menu/menu_page.dart](../views_after_auth_screens_menu_menu_page/)
3.  MenuPage class
...
MenuPage returns a widget that renders a menu page with vertical stack
of links.
...
[[MenuPage.new](../views_after_auth_screens_menu_menu_page/MenuPage/MenuPage.md)][]
...
[[build](../views_after_auth_screens_menu_menu_page/MenuPage/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
1.  [talawa](../index.md)
2.  [menu_page](../views_after_auth_screens_menu_menu_page/)
3.  MenuPage class
