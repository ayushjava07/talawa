...
[[BaseFeedManager.new](../services_caching_base_feed_manager/BaseFeedManager/BaseFeedManager.md)][([[[String](https://api.flutter.dev/flutter/dart-core/String-class.md)] cacheKey])]
