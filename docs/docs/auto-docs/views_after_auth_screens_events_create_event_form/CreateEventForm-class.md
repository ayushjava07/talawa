...
CreateEventForm returns a widget of a Form for creating events in the
organization. This widget is used in CreateEventPage widget.
...
[[CreateEventForm.new](../views_after_auth_screens_events_create_event_form/CreateEventForm/CreateEventForm.md)][]
...
[[build](../views_after_auth_screens_events_create_event_form/CreateEventForm/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
