...
[[cacheManager](../views_after_auth_screens_feed_pinned_post_screen/PinnedPostScreen/cacheManager.md)] [→ [BaseCacheManager](https://pub.dev/documentation/flutter_cache_manager/3.4.1/flutter_cache_manager/BaseCacheManager-class.html)?]
:   Custom avatar data.
    ::: features
    final
    :::
...
[[createState](../views_after_auth_screens_feed_pinned_post_screen/PinnedPostScreen/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[PinnedPostScreen](../views_after_auth_screens_feed_pinned_post_screen/PinnedPostScreen-class.md)]\>]] ]
