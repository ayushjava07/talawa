...
[[CachedUserAction.new](../models_caching_cached_user_action/CachedUserAction/CachedUserAction.md)][]
...
[[execute](../models_caching_cached_user_action/CachedUserAction/execute.md)][ [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)[\<[[QueryResult](https://pub.dev/documentation/graphql/5.2.3/graphql/QueryResult-class.html)[\<[[Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)?]\>]]\>]] ]
