...
[[BaseView.new](../views_base_view/BaseView/BaseView.md)][]
...
[[builder](../views_base_view/BaseView/builder.md)] [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html) Function[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)], ][T, ][[[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]])]]
