...
A progress dialogue which shows an activity indicator spinning clockwise
if there is internet connectivity. Otherwise, it shows no-internet image
and text.
...
[[CustomProgressDialog.new](../widgets_custom_progress_dialog/CustomProgressDialog/CustomProgressDialog.md)][]
...
[[build](../widgets_custom_progress_dialog/CustomProgressDialog/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
