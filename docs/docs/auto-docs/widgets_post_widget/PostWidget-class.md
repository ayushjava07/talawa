...
[[PostWidget.new](../widgets_post_widget/PostWidget/PostWidget.md)][]
...
[[deletePost](../widgets_post_widget/PostWidget/deletePost.md)] [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.md)]])]?]
...
[[post](../widgets_post_widget/PostWidget/post.md)] [→ [Post](../models_post_post_model/Post-class.md)]
:   Post object containing all the data related to the post.
    ::: features
    final
    :::

[[redirectToIndividualPage](../widgets_post_widget/PostWidget/redirectToIndividualPage.md)] [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.md)]])]?]
...
[[build](../widgets_post_widget/PostWidget/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
