...
which shows the list of all organizations exists in the URL. This widget
is used after the authentication.
...
[[OrganizationList.new](../widgets_organization_list/OrganizationList/OrganizationList.md)][]
...
[[build](../widgets_organization_list/OrganizationList/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
