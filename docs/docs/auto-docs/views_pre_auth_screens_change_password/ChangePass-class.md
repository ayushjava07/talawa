...
This widget lets the user change his/her password. There are two input
fields. The first one is for entering the new password, and the second
one is for re-entering the password for verification. There is a raised
button which finally updates the password when pressed.
...
[[ChangePass.new](../views_pre_auth_screens_change_password/ChangePass/ChangePass.md)][]
