1.  [Constructors](./CommentInteractions-class#constructors.md)
2.  [new](./CommentInteractions/CommentInteractions.md)
3.  [Properties](./CommentInteractions-class#instance-properties.md)
4.  [comment](./CommentInteractions/comment.md)
...
20. [Operators](./CommentInteractions-class#operators.md)
21. [operator
