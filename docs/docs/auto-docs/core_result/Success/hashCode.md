...
3.  Success[\<[T\>]](../../core_result/Success-class.md)
4.  hashCode property
...
==](../../core_result/Success/operator_equals.md) comparisons.
...
[operator ==](../../core_result/Success/operator_equals.md)
...
If [operator ==](../../core_result/Success/operator_equals.md) is
...
==](../../core_result/Success/operator_equals.md). The hash code of an
object should only change if the object changes in a way that affects
...
[hashCode](../../core_result/Success/hashCode.md), it should override
the [operator ==](../../core_result/Success/operator_equals.md)
