...
3.  Failure[\<[T\>]](../../core_result/Failure-class.md)
4.  hashCode property
...
==](../../core_result/Failure/operator_equals.md) comparisons.
...
[operator ==](../../core_result/Failure/operator_equals.md)
...
If [operator ==](../../core_result/Failure/operator_equals.md) is
...
==](../../core_result/Failure/operator_equals.md). The hash code of an
...
[hashCode](../../core_result/Failure/hashCode.md), it should override
the [operator ==](../../core_result/Failure/operator_equals.md)
