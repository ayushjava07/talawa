...
There is a list tile which displays the organization selected by the
user. He/she needs to press the \"continue\" button to proceed.
...
[[SelectOrganization.new](../views_pre_auth_screens_select_organization/SelectOrganization/SelectOrganization.md)][]
