...
This class recovers the users password. The users needs to enter his/her
email and press on the button at the bottom to recover his/her password.
...
[[Recover.new](../views_pre_auth_screens_recover/Recover/Recover.md)][]
