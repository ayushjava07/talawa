...
==](../../enums_enums/VoteTypeAdapter/operator_equals.md) comparisons.
...
[operator ==](../../enums_enums/VoteTypeAdapter/operator_equals.md)
...
If [operator ==](../../enums_enums/VoteTypeAdapter/operator_equals.md)
...
==](../../enums_enums/VoteTypeAdapter/operator_equals.md). The hash
code of an object should only change if the object changes in a way that
affects equality. There are no further requirements for the hash codes.
They need not be consistent between executions of the same program and
...
[hashCode](../../enums_enums/VoteTypeAdapter/hashCode.md), it should
override the [operator
==](../../enums_enums/VoteTypeAdapter/operator_equals.md) operator as
