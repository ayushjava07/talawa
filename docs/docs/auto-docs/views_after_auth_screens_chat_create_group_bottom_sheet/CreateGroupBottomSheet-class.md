...
3.  CreateGroupBottomSheet class
...
CreateGroupBottomSheet is a bottom sheet widget for creating new group
chats.
...
[[CreateGroupBottomSheet.new](../views_after_auth_screens_chat_create_group_bottom_sheet/CreateGroupBottomSheet/CreateGroupBottomSheet.md)][]
...
[[createState](../views_after_auth_screens_chat_create_group_bottom_sheet/CreateGroupBottomSheet/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[CreateGroupBottomSheet](../views_after_auth_screens_chat_create_group_bottom_sheet/CreateGroupBottomSheet-class.md)]\>]] ]
...
##### create_group_bottom_sheet library
