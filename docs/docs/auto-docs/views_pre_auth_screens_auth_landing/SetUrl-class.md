...
1.  [talawa](../index.md)
2.  [views/pre_auth_screens/auth_landing.dart](../views_pre_auth_screens_auth_landing/)
3.  SetUrl class
...
enter the organization URL and then login. There is also a signup option
which navigates to a screen for the user to select an organization. At
the bottom, there is also a gesture detector for changing the language.
...
[[SetUrl.new](../views_pre_auth_screens_auth_landing/SetUrl/SetUrl.md)][]
...
[createState](../views_pre_auth_screens_auth_landing/SetUrl/createState.md) [→ \_SetUrlState ]
...
1.  [talawa](../index.md)
2.  [auth_landing](../views_pre_auth_screens_auth_landing/)
3.  SetUrl class
