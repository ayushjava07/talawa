...
[[LanguageTile.new](../widgets_lang_switch/LanguageTile/LanguageTile.md)][]
...
[[build](../widgets_lang_switch/LanguageTile/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
