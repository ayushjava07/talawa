...
[[FromPalisadoes.new](../widgets_from_palisadoes/FromPalisadoes/FromPalisadoes.md)][]
...
[[build](../widgets_from_palisadoes/FromPalisadoes/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
