...
[[CustomRichText.new](../widgets_rich_text/CustomRichText/CustomRichText.md)][]
...
[[build](../widgets_rich_text/CustomRichText/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
