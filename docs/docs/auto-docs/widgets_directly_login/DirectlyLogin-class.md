...
On clicking on the email, yhe user will automatically logged in using
the credential stored in local storage securely.
...
[[DirectlyLogin.new](../widgets_directly_login/DirectlyLogin/DirectlyLogin.md)][]
...
[[model](../widgets_directly_login/DirectlyLogin/model.md)] [→ [LoginViewModel](../view_model_pre_auth_view_models_login_view_model/LoginViewModel-class.md)]
...
[[build](../widgets_directly_login/DirectlyLogin/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
[[loginUsingPrevCredentials](../widgets_directly_login/DirectlyLogin/loginUsingPrevCredentials.md)][ [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)\<[void\>]] ]
