...
GroupChatInputField returns a widget that has mutable state for group
chat input.
...
[[GroupChatInputField.new](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField/GroupChatInputField.md)][]
...
[[chatId](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField/chatId.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
:   ChatId.
    ::: features
    final
    :::
...
[[model](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField/model.md)] [→ [GroupChatViewModel](../view_model_after_auth_view_models_chat_view_models_group_chat_view_model/GroupChatViewModel-class.md)]
...
[[createState](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[GroupChatInputField](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField-class.md)]\>]] ]
...
##### group_chat_input_field library
