...
3.  GroupChatMessageScreen class
...
GroupChatMessageScreen returns a StatefulWidget for showing group chat
messages with admin features.

This screen is specifically designed for group chats (3+ members) and
includes:
...
[[GroupChatMessageScreen.new](../views_after_auth_screens_chat_group_chat_message_screen/GroupChatMessageScreen/GroupChatMessageScreen.md)][]
...
[[chatId](../views_after_auth_screens_chat_group_chat_message_screen/GroupChatMessageScreen/chatId.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[model](../views_after_auth_screens_chat_group_chat_message_screen/GroupChatMessageScreen/model.md)] [→ [GroupChatViewModel](../view_model_after_auth_view_models_chat_view_models_group_chat_view_model/GroupChatViewModel-class.md)]
:   The GroupChatViewModel instance that manages group chat state and
    messages.
    ::: features
    final
    :::
...
[[createState](../views_after_auth_screens_chat_group_chat_message_screen/GroupChatMessageScreen/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[GroupChatMessageScreen](../views_after_auth_screens_chat_group_chat_message_screen/GroupChatMessageScreen-class.md)]\>]] ]
...
##### group_chat_message_screen library
