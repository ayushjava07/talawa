...
[[TalawaErrorDialog.new](../widgets_talawa_error_dialog/TalawaErrorDialog/TalawaErrorDialog.md)][([[[String](https://api.flutter.dev/flutter/dart-core/String-class.md)] errorMessage, )]
...
[[build](../widgets_talawa_error_dialog/TalawaErrorDialog/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
