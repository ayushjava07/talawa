...
1.  [talawa](../index.md)
2.  [widgets/fund_build_info_row.dart](../widgets_fund_build_info_row/)
3.  FundBuildInfoRow class
...
# FundBuildInfoRow class

</div>


A widget that displays a row of information with an icon, label, and
value.
...
[[FundBuildInfoRow.new](../widgets_fund_build_info_row/FundBuildInfoRow/FundBuildInfoRow.md)][]
...
[[icon](../widgets_fund_build_info_row/FundBuildInfoRow/icon.md)] [→ [IconData](https://api.flutter.dev/flutter/widgets/IconData-class.html)]
...
[[label](../widgets_fund_build_info_row/FundBuildInfoRow/label.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[value](../widgets_fund_build_info_row/FundBuildInfoRow/value.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[build](../widgets_fund_build_info_row/FundBuildInfoRow/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
1.  [talawa](../index.md)
2.  [fund_build_info_row](../widgets_fund_build_info_row/)
3.  FundBuildInfoRow class

##### fund_build_info_row library
