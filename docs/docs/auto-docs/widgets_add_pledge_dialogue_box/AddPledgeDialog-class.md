...
1.  [talawa](../index.md)
2.  [widgets/add_pledge_dialogue_box.dart](../widgets_add_pledge_dialogue_box/)
3.  AddPledgeDialog class
...
# AddPledgeDialog class

</div>


A dialog widget for creating a pledge, allowing the user to input pledge
details.
...
[[AddPledgeDialog.new](../widgets_add_pledge_dialogue_box/AddPledgeDialog/AddPledgeDialog.md)][]
...
[[campaign](../widgets_add_pledge_dialogue_box/AddPledgeDialog/campaign.md)] [→ [Campaign](../models_funds_fund_campaign/Campaign-class.md)]
...
[[model](../widgets_add_pledge_dialogue_box/AddPledgeDialog/model.md)] [→ [FundViewModel](../view_model_after_auth_view_models_fund_view_model_fund_view_model/FundViewModel-class.md)]
...
[createState](../widgets_add_pledge_dialogue_box/AddPledgeDialog/createState.md) [→ \_AddPledgeDialogState ]
...
1.  [talawa](../index.md)
2.  [add_pledge_dialogue_box](../widgets_add_pledge_dialogue_box/)
3.  AddPledgeDialog class

##### add_pledge_dialogue_box library
