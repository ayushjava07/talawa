...
EventInfoBody returns a stateless widget which describes the body of a
particular event.
...
[[EventInfoBody.new](../views_after_auth_screens_events_event_info_body/EventInfoBody/EventInfoBody.md)][]
...
[[build](../views_after_auth_screens_events_event_info_body/EventInfoBody/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
