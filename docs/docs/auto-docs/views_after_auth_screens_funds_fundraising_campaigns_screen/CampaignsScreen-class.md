...
The CampaignsScreen widget displays a list of campaigns associated with
a specific fund.
...
[[CampaignsScreen.new](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen/CampaignsScreen.md)][]
...
[[fundId](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen/fundId.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
:   The unique identifier for the fund whose campaigns are to be
    displayed.
    ::: features
    final
    :::

[[fundName](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen/fundName.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[createState](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[CampaignsScreen](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen-class.md)]\>]] ]
