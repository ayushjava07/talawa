...
This widget represents the settings page of the application. It allows
users to configure various application settings.
...
[[AppSettingsPage.new](../views_after_auth_screens_app_settings_app_settings_page/AppSettingsPage/AppSettingsPage.md)][]
...
[[createState](../views_after_auth_screens_app_settings_app_settings_page/AppSettingsPage/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[AppSettingsPage](../views_after_auth_screens_app_settings_app_settings_page/AppSettingsPage-class.md)]\>]] ]
