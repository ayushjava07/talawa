...
The avatar is created using the image provided, or the first alphabet
with a standard background color.
...
[[CustomAvatar.new](../widgets_custom_avatar/CustomAvatar/CustomAvatar.md)][]
...
[[cacheManager](../widgets_custom_avatar/CustomAvatar/cacheManager.md)] [→ [BaseCacheManager](https://pub.dev/documentation/flutter_cache_manager/3.4.1/flutter_cache_manager/BaseCacheManager-class.html)?]
:   Custom avatar data.
    ::: features
    final
    :::
...
[[maxRadius](../widgets_custom_avatar/CustomAvatar/maxRadius.md)] [→ [double](https://api.flutter.dev/flutter/dart-core/double-class.html)?]
:   Custom avatar data.
    ::: features
    final
    :::
...
[[build](../widgets_custom_avatar/CustomAvatar/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
