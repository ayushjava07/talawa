...
[[PledgeCard.new](../widgets_pledge_card/PledgeCard/PledgeCard.md)][]
...
[[onDelete](../widgets_pledge_card/PledgeCard/onDelete.md)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
:   Delete callback function.
    ::: features
    final
    :::

[[onUpdate](../widgets_pledge_card/PledgeCard/onUpdate.md)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
:   Update callback function.
    ::: features
    final
    :::

[[pledge](../widgets_pledge_card/PledgeCard/pledge.md)] [→ [Pledge](../models_funds_fund_pledges/Pledge-class.md)]
...
[[build](../widgets_pledge_card/PledgeCard/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
[[formatDate](../widgets_pledge_card/PledgeCard/formatDate.md)][([[[DateTime](https://api.flutter.dev/flutter/dart-core/DateTime-class.md)?] date]) [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)] ]
:   Date Formatter.
