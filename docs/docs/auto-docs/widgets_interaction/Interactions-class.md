...
[[Interactions.new](../widgets_interaction/Interactions/Interactions.md)][]
...
[[post](../widgets_interaction/Interactions/post.md)] [→ [Post](../models_post_post_model/Post-class.md)]
:   Details of post.
    ::: features
    final
    :::

[[redirectToIndividualPage](../widgets_interaction/Interactions/redirectToIndividualPage.md)] [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.md)] p])]?]
...
[[build](../widgets_interaction/Interactions/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
