...
A widget to display the caption of a post with support for hashtags and
expandable text.
...
[[CaptionTextWidget.new](../widgets_caption_text_widget/CaptionTextWidget/CaptionTextWidget.md)][]
...
[[caption](../widgets_caption_text_widget/CaptionTextWidget/caption.md)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[createState](../widgets_caption_text_widget/CaptionTextWidget/createState.md)][ [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[CaptionTextWidget](../widgets_caption_text_widget/CaptionTextWidget-class.md)]\>]] ]
